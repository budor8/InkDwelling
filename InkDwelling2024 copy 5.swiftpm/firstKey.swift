...
struct firstKey: View {
    let text = "■ it looks like a key of some sort.. wonder what it opens "
    ...
    var body: some View {
        ...
        if navigate {
            ...
            GeometryReader{_ in
                ...
                ZStack{
                    Image("room1_dark").resizable().scaledToFit().padding(.horizontal,20)
    ...
    struct  firstKey_Previews: PreviewProvider {
